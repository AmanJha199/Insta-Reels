...
import { unstable_subscribe } from 'scheduler/tracing';
...
function Posts({ userData = null }) {
    ...
    useEffect(() => {
        ...
        const unsub = database.posts.orderBy('createdAt','desc').onSnapshot(querySnapshot =>{
            //ye hmne empty kiya he duplicacy se bachne ke liye
            parr=[];
    ...
    useEffect(()=>{
        ...
        return ()=>{
            //basically jo poorani videos he unko disconnect krke nyi ke saath event listener attch ho gya
            Observer.disconnect();
        }
    },[posts])
    return (
